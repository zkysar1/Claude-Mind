...
def main():
    ...
    ap.add_argument("--env-id", default="claude-mind", help="environment id (key prefix); default claude-mind")
    ap.add_argument("--user", default="Zak_claude_mind", help="scoped IAM user name")
