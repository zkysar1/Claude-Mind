...
This file supplements `core/config/verification-checklist.md` with domain-specific
verification items. It is seeded into `world/verification-checklist.md` during
init-world.sh. Customize for your domain or delete if not needed.
