"""g-115-3719: the experience write path re-fences and retries (class-(b) cure).
...
# ---------------------------------------------------------------------------
# add() — the site the g-115-3783 incident actually wedged on
# ---------------------------------------------------------------------------
