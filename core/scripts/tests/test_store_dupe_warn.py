#!/usr/bin/env python3
"""Tests for the advisory add-time near-duplicate warning (g-115-3223).
...
# --------------------------------------------------------------------------- #
# Verification outcome 2 of g-115-3223 asks for proof that the record still lands
...
# --------------------------------------------------------------------------- #
# 5. Telemetry (g-115-3626) — END-TO-END, not structural
#
...
#
# Hermeticity: AYOAI_META redirects the firing log to tmp_path (never the live
...
def test_telemetry_failure_cannot_break_the_helper(seeded):
    """Point AYOAI_META at a path that cannot be written. The advisory must
