#!/usr/bin/env python3
"""Static guards for the  defect class: fail-open-guarded FILING
...
def test_shell_scripts_still_parse():
    ...
    for path in (CORE_SCRIPTS / "iteration-close.sh",
        ...
        # Resolve bash EXPLICITLY via the shared helper (guard-580, ).
        ...
        # BASH is computed once at import and honors MIND_SHELL / Git-Bash.
