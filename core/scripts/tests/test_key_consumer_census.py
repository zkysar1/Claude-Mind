"""test_key_consumer_census.py — regression tests for g-115-3642 (gap-029).
...
# g-115-3611. The census table was set-valued, so a file with four write sites
...
# enumerate-sites, CONFIRMED by alpha via g-335-427): a goal named 9 sites, the
