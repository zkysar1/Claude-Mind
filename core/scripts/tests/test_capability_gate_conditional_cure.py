"""test_capability_gate_conditional_cure.py — regression tests for g-115-3813.
...
# shape (g-115-372) that a disproved cure must become indistinguishable from.
...
def test_disproved_cure_matches_sanctioned_none_cure_semantics(suffix):
    """A disproved cure must land in the bucket g-115-372 already sanctioned.
