...
def _load_forged_skill_names() -> set:
    """Return the set of forged-skill names from world/forged-skills.yaml.

    Empty set on any read/parse error (fail-open). The registry is authoritative
...
def main():
    ...
    forged_names = _load_forged_skill_names()
