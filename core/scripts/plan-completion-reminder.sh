...
# that commands: CLEAR the plan and ANSWER the user's original request with a
# verdict — never end on "plan finished". A plan TOOL's results are not this
# hook's business (branch retired 2026-09-21: the harness owns the moment its
# own plan completes). The why, with the measurements: the .py docstring.
